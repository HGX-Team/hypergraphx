...
class Hypergraph:
    ...
    def degree(self, node, order=None, size=None):
        from hnx.measures.degree import degree
    ...
    def binary_incidence_matrix(
        ...
        from hnx.linalg import binary_incidence_matrix
