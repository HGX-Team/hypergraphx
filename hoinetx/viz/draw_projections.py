...
from hoinetx.representations.projections import bipartite_projection, clique_projection
...
def draw_bipartite(h: Hypergraph, pos=None, ax=None, align='vertical', **kwargs):
    ...
    kwargs : dict. Keyword arguments to be passed to networkx.draw_networkx.
    align : str. The alignment of the nodes. Can be 'vertical' or 'horizontal'.
